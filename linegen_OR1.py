...
class LineGen:
    ...
    def generate(self, primer_text, str_len, include_primer=True, strip=False):
        ...
        return out_str
    def generate_multi(self, primer_text, str_len, count, strip=False):
    ...
    def run(self, a, b):
        ...
        out_str = a
        out_str = self.generate(out_str, random.randrange(5, 7), strip=True) + ' ' + b
        out_str = self.generate(out_str, random.randrange(5, 7), strip=True)
        return out_str
