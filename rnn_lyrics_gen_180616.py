...
#     trained RNN model.
# Usage:
#     python rnn_lyrics_gen_180616.py <model-path> <priming-phrase> <#-of-char-to-append>
# Notes:
...
if __name__  == '__main__':
    ...
    rnn = RNNLyricsGen180616(model_path)
