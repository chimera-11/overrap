# ---------------------------------------------
#   rnn_perplexity_180514.py
#   Copyright (C) 2018 Ahn Byeongkeun
# ---------------------------------------------
# Description:
#     This module evaluates given lyrics based on 
#     trained RNN model. The probability of the lyrics
#     from the point of view of the RNN model is computed.
# Usage:
#     python rnn_perplexity_180514.py <model-path> <text-file-path>
# Notes:
